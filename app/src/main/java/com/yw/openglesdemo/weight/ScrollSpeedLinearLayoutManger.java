package com.yw.openglesdemo.weight;
...
public class ScrollSpeedLinearLayoutManger extends LinearLayoutManager {
    ...
    public ScrollSpeedLinearLayoutManger(Context context, boolean flag) {
        super(context, flag == true ? HORIZONTAL : VERTICAL, false);
    }
